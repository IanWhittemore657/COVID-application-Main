...
class ReportSpecificPage extends StatefulWidget {
  @override
  _ReportSpecificPageState createState() => _ReportSpecificPageState();
}


class _ReportSpecificPageState extends State<ReportSpecificPage>  {
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text("Specific Reports",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                ),

                Expanded(
                  child: Container(
                    child: StreamBuilder(
                        stream: Firestore.instance.collection("User Input").document("xnTEUIQWbAUGEldxH8aXvE5UDUq2").collection("Specific Report").orderBy('Date', descending: true).snapshots(),
                                        ...
                                        children: <Widget>[
                                          ...
                                          Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Text("Description",style: TextStyle(fontSize: 18,color: Colors.black,decoration: TextDecoration.underline),textAlign: TextAlign.center,),
                                           SizedBox(height: 10,),
                                            Text(" ${document['Description'] ?? "No Data"}",style: TextStyle(fontSize: 16,color: Colors.black),textAlign: TextAlign.center,),
