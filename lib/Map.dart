...
//  }
  ...
  populateClients() {
    clients = [];
    Firestore.instance.collection("User Input").document("xnTEUIQWbAUGEldxH8aXvE5UDUq2").collection("Photos").orderBy('Date', descending: true).getDocuments().then((docs) {
  ...
  initMarker(client) {
    ...
    setState(() {
      allMakers.add(Marker(
        ...
        draggable: false,
        infoWindow:
        InfoWindow(title: "${client["Locality"] ?? "No Data"}", snippet: "  ${client["PostCode"] ?? "No Data"}"),
                      ...
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text("Country           :",style: TextStyle(fontSize: 12,color: Colors.black),),
